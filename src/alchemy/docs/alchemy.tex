...
\begin{equation}
	\delta\vec{U}_{n+1/3} = \vec{U}^\star - \vec{U}_n
\end{equation}
so that we can compute
\begin{equation}
	\vec{U}_{n+1/3} = \vec{U}_n + \delta\vec{U}_{n+1/3} = \vec{U}^\star
\end{equation}

\begin{equation}
	\vec{C}_{n+1/3} = \mathcal{C}\left(\mytrn{\mymat{P}}\vec{U}_{n+1/3}+ \mytrn{\mymat{Q}}\vec{V}_n\right)
\end{equation}
and we redefine
\begin{equation}
	\vec{U}_{n+2/3} = \left(\mymat{P}\mytrn{\mymat{P}}\right)^{-1} \mymat{P} \vec{C}_{n+1/3}, \;\;\; \vec{V}_{n+1/3} = \mymat{Q} \vec{C}_{n+1/3}
\end{equation}

Then we compute $\vec{\Gamma}\left(\vec{C}_{n+1/3}\right)$ and $\mymat{\Phi}_{n+1/3}$ and we expand
\begin{equation}
	\vec{0} \approx  \vec{\Gamma}_{n+1/3} 
	%+ \left(\mymat{\Phi} \mytrn{\mymat{P}}\right) \delta\vec{U}_{n+2/3} 
	+ \left(\mymat{\Phi} \mytrn{\mymat{Q}}\right) \delta\vec{V}_{n}
\end{equation}
and we define
\begin{equation}
	\vec{V}_{n+2/3} = \vec{V}_{n+1/3} + \delta\vec{V}_{n}
\end{equation}

\begin{equation}
	\vec{C}_{n+1} = \mathcal{C}\left(\mytrn{\mymat{P}}\vec{U}_{n+2/3} + \mytrn{\mymat{Q}} \vec{V}_{n+2/3} \right)
\end{equation}
