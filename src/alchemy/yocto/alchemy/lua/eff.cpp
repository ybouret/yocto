...
namespace yocto
{
    namespace  alchemy
    {
        ...
        namespace
        {
            ...
            public:
                          ...
                          const variables     &params)
                {
                    ...
                    __lua::push(L,Cin,params.shlib);   ++nargs;
                    __lua::push(L,Cout,params.shlib);  ++nargs;
        ...
        void __lua:: load( Lua::State::Pointer &vm, effectors &edb, const string &id )
        {
            lua_State *L = **vm;
            lua_settop(L,0);
