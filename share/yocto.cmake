...
FUNCTION(YOCTO_FIND_COMPILER_VERSION)
	...
	STRING( REGEX REPLACE  "([0-9]+)\\.[0-9]+\\.[0-9]+" "\\1" YOCTO_COMPILER_MAJOR "${YC_VERSION}")
	STRING( REGEX REPLACE  "[0-9]+\\.([0-9]+)\\.[0-9]+" "\\1" YOCTO_COMPILER_MINOR "${YC_VERSION}")
	STRING( REGEX REPLACE  "[0-9]+\\.[0-9]+\\.([0-9]+)" "\\1" YOCTO_COMPILER_PATCH "${YC_VERSION}")
...
IF( "${CC_NAME}" MATCHES "^gcc.*" )
	...
	SET(COMMON_CXX_FLAGS        "-Wall -pipe -fexceptions -Weffc++ ${PIC_FLAGS}" )
...
########################################################################
 IF( "${CC_NAME}" MATCHES "^clang.*" )
	...
	IF( "${YOCTO_COMPILER_VERSION}" VERSION_GREATER_EQUAL "8.1.0")
